      ...
      <section className="section-bodytext">
        <div className="page-padding">
          <div className="container-large">
            <section className="info_component">
              <div className="info-title-wrapper">
                <h4 className="flip-left-in heading-4 titulo">The Host</h4>
                <h3 
                // style="-webkit-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(-87deg) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(-87deg) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(-87deg) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(-87deg) rotateY(0) rotateZ(0) skew(0, 0);transform-style:preserve-3d" 
                className="flip-left-in"><span className="the-span">Guru </span>RAMANATHAN</h3>
              </div>
              <div className="info-wrapper">
                <div className="padding-left padding-medium">
                  <p className="info-p right-in prevphoto">Hello and welcome to <strong className="bolded">Found in Translation</strong>. <br />I&#x27;m your host Guru Ramanathan. <br /></p>
                  ...
                  <p className="info-p right-in prevphoto">
                    <a href="https://www.rachelhaeunlee.com/" target="_blank" className="hoverable-link">‍</a>This week&#x27;s guest and our first guest ever is the lovely and endlessly talented , <br />
                  ...
                  <p className="info-p right-in">nmnlkmkllkmlm<br /></p>
                  <div className="cursor-wrapper">
                    <div data-w-id="107d102a-268a-ab21-d26c-c7c513c078f2" className="cursor-dot"></div>
                    <div className="w-embed">
                    </div>
                  </div>
                  <p className="info-p right-in">m knjlnk<br /></p>
                  ...
                  <p className="info-p right-in">cghcjhvk<br /></p>
                </div>
              </div>
            </section>
            ...
            <div className="info_component">
              <div className="info-title-wrapper">
                <h4 className="flip-left-in heading-4 titulo">The Guest</h4>
                <h3 
                // style="-webkit-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(-87deg) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(-87deg) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(-87deg) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(-87deg) rotateY(0) rotateZ(0) skew(0, 0);transform-style:preserve-3d" 
                className="flip-left-in"><span className="the-span">CYnthia</span></h3>
              </div>
              <div className="info-wrapper rachel">
                <div className="padding-left padding-medium">
                  <div>
                    <div className="quote-text right-in in-para">my mom is hard of hearing and my dad is fully deaf.</div>
                  </div>
                  <div className="info-p right-in">And so in the deaf community, that would make me a <strong className="bolded">Coda</strong>. So that&#x27;s a child of deaf, I guess, in my case, adults sometimes. People could have one or two, obviously. So I usually ask this question a lot to my mom because I, for the longest time didn&#x27;t know what came first.</div>
                  <div className="cursor-wrapper">
                    <div data-w-id="107d102a-268a-ab21-d26c-c7c513c078f2" className="cursor-dot"></div>
                    <div className="w-embed">
                    </div>
                  </div>
                  <p className="info-p right-in prevphoto">It was kind of like, you know, the chicken and the egg question. What came first ESL or English. And the consensus is both. It was a dual language kind of thing. But I started taking ASL classNamees with my mom when I was about three years old. And I have pictures in my house of just me and my mom practicing gestures.<br /></p><img className="image-414 phot-fader" src="images/mimicking-mom.jpg" alt="" sizes="(max-width: 479px) 89vw, 45vw" data-w-id="258d5e9c-4b25-f942-79bf-2efe3def5572" loading="lazy" srcset="images/mimicking-mom-p-500.jpg 500w, images/mimicking-mom-p-800.jpg 800w, images/mimicking-mom.jpg 960w" />
                  <div className="info-p right-in">I&#x27;m mimicking my mom, like touching my nose and touching my ears and touching my head and, you know, just lots of visual stuff. And then for my elementary to middle school time, I went to an integrated school in the city where there were deaf students. Part of hearing students and students who were hearing like me who may have deaf parents like I did.</div>
                  <p className="info-p right-in">And it was sort of like this nice tight knit community that my family felt was a good safe space for both their child&#x27;s education, but also their ability to be in touch with their child&#x27;s education. And then, when I went to high school, I decided I wanted to go outside of that bubble and that&#x27;s kind of where the formal classNamees ended.<br /></p>
                </div>
              </div>
            </div>
            <div className="info_component">
            ...
            <div className="info_component">
              ...
              <div className="info-wrapper rachel">
                <div className="padding-left padding-medium">
                  <p className="info-p right-in">In terms of translating, I feel like it&#x27;s a lot of similarities to a lot of immigrant family households. My mom herself is an immigrant from the Dominican Republic. <br /></p>
                  <p className="info-p right-in">I felt like I had to grow up pretty early on just because the moment I became at least semi fluent in English, I had to translate for my parents, whether it be for, government offices or the post office, or some store, restaurant, et cetera, like I was taking phone calls and filling out forms left and right for them. And that was, that was a lot.<br /></p>
                  <p className="info-p right-in">In terms of school, I didn&#x27;t have to worry about parent teacher conferences because the teachers there, some of them were deaf themselves.<br /></p>
                  <div className="cursor-wrapper">
                    <div data-w-id="107d102a-268a-ab21-d26c-c7c513c078f2" className="cursor-dot"></div>
                    <div className="w-embed">
                    </div>
                  </div>
                  <div className="info-p right-in">Some of them knew how to sign and did the formal education that they needed to support those students. And so I never had to worry about getting an interpreter until I went to high school and that&#x27;s when things started going downhill.</div>
                </div>
              </div>
            </div>
            <div className="info_component">
              ...
              <div className="info-wrapper rachel">
                <div className="padding-left padding-medium">
                  <p className="info-p right-in">When you were growing up, did you have a preference of ASL or English being your primary language and how did that kind of affect, your own self of being immersed in deaf culture<br /></p>
                  <div className="cursor-wrapper">
                    <div data-w-id="107d102a-268a-ab21-d26c-c7c513c078f2" className="cursor-dot"></div>
                    <div className="w-embed">
                    </div>
            ...
            <div className="info_component">
              ...
              <div className="info-wrapper rachel">
                <div className="padding-left padding-medium">
                  <p className="info-p right-in">I had a preference of English just because in the beginning, I wasn&#x27;t really good at it. It was part of the experience of being a child with two deaf adults is that you kind of lose unless you have, you know, hearing family members outside of your immediate family that will help you develop the language.<br /></p>
                  <p className="info-p right-in">I didn&#x27;t have that. So a lot of my issues with English kind of manifested when I went to school, I had to go to speech therapy for like five years. That made me appreciate ASL more because I at least I had to think about this, but I&#x27;m able to better describe a word that I&#x27;m missing in ASL than describe a word that I&#x27;m missing in English.<br /></p>
                  <p className="info-p right-in">So that&#x27;s kind of like a way that I can describe my relationship to ASL more, but I guess now if I were to compare it to how I felt before, I feel more comfortable speaking in English than ASL.<br /></p>
                  <div className="cursor-wrapper">
                    <div data-w-id="107d102a-268a-ab21-d26c-c7c513c078f2" className="cursor-dot"></div>
                    <div className="w-embed">
                    </div>
            ...
            <div className="info_component">
              <div className="info-wrapper">
                ...
                <div className="info-p right-in"><strong className="bold-text">And is there a reason for that?</strong></div>
            ...
            <div className="info_component">
              ...
              <div className="info-wrapper rachel">
                <div className="padding-left padding-medium">
                  ...
                  <p className="info-p right-in">That&#x27;s a good question. In terms of race and ethnicity, it was actually very diverse. I never felt isolated in terms of my ethnicity as a Puerto Rican and Dominican individual.<br /></p>
                  <p className="info-p right-in">My friend group was predominantly hearing people, even though I did have friends who were hard of hearing and deaf, but you know, when I would go sit the lunch table, I would be with the hearing kids. I would sit down with the hearing kids.<br /></p>
                  <p className="info-p right-in">Sometimes certain subjects we would separate the className. So that kind of created the pockets, I think fundamentally, but I never felt like I only had to stay in that circle. I think I was just the type of person that I didn&#x27;t care.<br /></p>
                </div>
              </div>
            </div>
            <div className="info_component">
              ...
              <div className="info-wrapper rachel">
                <div className="padding-left padding-medium">
                  ...
                  <p className="info-p right-in">I feel like I&#x27;ve talked too on this podcast and also just in my life, there have been people who have the ability to let&#x27;s say have a foot in two worlds at once and you hear from one side, you&#x27;re not X enough to be in this community.<br /></p>
                  <p className="info-p right-in">And then hear from the, you hear the same thing from the other side. And so I&#x27;m curious if that ever came up from some of your heart of hearing or deaf friends who are saying like, oh, you&#x27;re not like actually deaf or heart of hearing.<br /></p>
                  <p className="info-p right-in">  Because you&#x27;re not actually deaf or heart of hearing, you can&#x27;t fully be immersed in this culture. And then there&#x27;s the other kids who are just have, you know, they can hear properly. Did you ever receive any comments like that?<br /></p>
                </div>
              </div>
            </div>
            ...
            <div className="info_component">
              ...
              <div className="info-wrapper rachel">
                <div className="padding-left padding-medium">
                  <p className="info-p right-in"><strong className="bolded">Yeah. Were talking a little bit earlier about oh, you didn&#x27;t grow up finding a lot of accessibility in public spaces and schools, or, anything of that nature.</strong><br /></p>
                  <p className="info-p right-in">And I mean, I&#x27;ll say this, growing up, I didn&#x27;t even see that or barely any, deaf characters or even just the use of ASL in films and in American films and shows and such. At least in the last two years I&#x27;ve seen a rise of ASL or just a more positive exposure of the deaf community in mainstream media.<br /></p>
                  <p className="info-p right-in">There was the film &quot;Coda&quot; that won best picture, the year before that there was &quot;Sound of Metal,&quot; which was got some Oscar nominations, and of course there was, there are &quot;Eternals,&quot; which was, I mean, huge Marvel film.<br /></p>
                  <p className="info-p right-in">And so I&#x27;m curious, how do you feel about the representation of ASL in mainstream media, then also at large, <strong className="bolded">are you seeing more acknowledgement or more accessible spaces, in regular society? Is that representation in media having an effect, a positive effect?</strong><br /></p>
                  <div className="cursor-wrapper">
                    <div data-w-id="107d102a-268a-ab21-d26c-c7c513c078f2" className="cursor-dot"></div>
                    <div className="w-embed">
                    </div>
            ...
            <div className="info_component">
              ...
              <div className="info-wrapper rachel">
                <div className="padding-left padding-medium">
                  <p className="info-p right-in">Mm-hmm. Well, first of all I see that &quot;Eternals&quot; were mentioned. I think that&#x27;s Lauren Ridloff. She was actually a teacher at my elementary school. She was a teacher before and then I guess she went into theater and acting. <br /></p>
                  <p className="info-p right-in">So that was pretty cool to see on the big screen. I know a lot of my elementary school, middle school friends were very proud of her to see her on the big screen. I know for me, the first semblance of representation was &quot;Switch at Birth.&quot; And that was a popular show where I swear like everybody that I meet now, even now, they&#x27;re like, oh my God, I watched &quot;Switch at Birth.&quot;<br /></p>
                  <div className="cursor-wrapper">
                    <div data-w-id="107d102a-268a-ab21-d26c-c7c513c078f2" className="cursor-dot"></div>
                    <div className="w-embed">
                    </div>
                  </div>
                  <p className="info-p right-in">I feel like back when it first aired and it got like a lot of buzz and like popularity, I was like, oh my God, I don&#x27;t know how to feel. This is kind of weird. I felt pressured to watch it too. and I did watch a few episodes, but...<br /></p>
                </div>
              </div>
            </div>
            <div className="info_component">
              ...
              <div className="info-wrapper rachel">
                <div className="padding-left padding-medium">
                  <p className="info-p right-in">Sorry, before you go on, when you say weird, did it make you uncomfortable or are you just like, not sure how to accept?<br /></p>
                  <div className="cursor-wrapper">
                    <div data-w-id="107d102a-268a-ab21-d26c-c7c513c078f2" className="cursor-dot"></div>
                    <div className="w-embed">
                    </div>
            ...
            <div className="info_component">
              ...
              <div className="info-wrapper rachel">
                <div className="padding-left padding-medium">
                  <p className="info-p right-in">I&#x27;m just remembering all the times where I have told people, oh yeah, my parents are deaf. And the first thing that they say to me is, oh, I&#x27;m so sorry.<br /></p>
                  <div className="cursor-wrapper">
                    <div data-w-id="107d102a-268a-ab21-d26c-c7c513c078f2" className="cursor-dot"></div>
                    <div className="w-embed">
                    </div>
                  </div>
                  <p className="info-p right-in">And then I&#x27;m like, oh, Okay. I didn&#x27;t say they were dead. I, like, they&#x27;re still alive as well. Like I never said anything of that nature. And so just see it on the screen and people being like, oh my God, that&#x27;s so cool. Like, I wanna learn, I can&#x27;t believe, this is like, never been a thing.<br /></p>
                  <p className="info-p right-in">It was bittersweet, I would say, but I feel like I&#x27;ve had a bunch of conversations about it with some of my deaf friends like, oh, what do you think of the show? And they seemed pretty happy to see that on the screen.<br /></p>
                  <p className="info-p right-in">And I&#x27;m happy that there&#x27;s more and there has been more since then. Has it done any fundamental changes? I don&#x27;t personally don&#x27;t think so. I guess the exposure has led to more people who are interested in learning the language. I guess maybe the exposure has led people to be more understanding of deaf people and you know, just know that they exist and that they deal with these issues.<br /></p>
                  <p className="info-p right-in">But I guess it&#x27;s hard for me to really say, cuz I am not the ones that are directly affected by it. My parents are. So there&#x27;s always that, that issue. I think part of the, the reason why, when you asked me to do this podcast in the back of my mind, I&#x27;m always like, I am speaking, not for myself. I am speaking for myself and my experiences, but at the end of the day, when it comes to, you know, Discussing whether or not, you know, represent things are being really represented I&#x27;m not speaking for myself.<br /></p>
                  <p className="info-p right-in">Part of the experience of learning ASL as someone who is hearing is learning more about your parents in the later stage of your life. I feel like as I&#x27;ve learned both languages at once, it took me a long time to really understand my parents. <br /></p>
                  <p className="info-p right-in">There are still times where I speak to my parents and there&#x27;s like a disconnect. I&#x27;m like, oh, I don&#x27;t really know what you&#x27;re saying. And they might have misunderstood what I said, and then it becomes this whole conflict. And then, you know, just screws up my perception of like, is this who my parents are?<br /></p>
                  <p className="info-p right-in">And I&#x27;m like, oh God, they&#x27;re being so annoying right now. But parents can be annoying. But I would say being able to communicate my feelings definitely helped a lot as I grew up because I know back then it was a lot more difficult for me to one, understand my own feelings and my connections with ASL, but also to convey it because I was able to convey it through writing.<br /></p>
                  <p className="info-p right-in">I forgot to mention this, but my parents are also illiterate. And that&#x27;s also just due to the lack of education and accessible, you know, educational stuff that they went through and they didn&#x27;t go through as children.<br /></p>
                  <p className="info-p right-in">I know this is not what every deaf person went through. There&#x27;s definitely a lot of privileged people out there that were able to get the education early on that were able to make the decision of whether or not they wanted to go through cochlear implants or hearing aids and whatnot.<br /></p>
                  <p className="info-p right-in">But from my experience, my parents experienced, they just had the low end of the stick and they weren&#x27;t fortunate enough to get that formal education. So ASL was really all they know. <br /></p>
                  <p className="info-p right-in">So, as someone who is learning both ASL and English and trying to convey their feelings, as well as understand their own feelings, it took a long time for me to tell my parents, oh, sometimes when you say this, it hurts my feelings. For them to respond, no, this is just, I&#x27;m just saying it because that&#x27;s just how I say it in this language. It&#x27;s not that I&#x27;m trying to hurt you. It&#x27;s just, I&#x27;m just trying to convey it to.<br /></p>
                  <p className="info-p right-in">I think definitely at my time at NYU, you know, being a psych major, that was more of a beneficial experience for me. I&#x27;m no, I&#x27;m no psychologists now, but that was my form of therapy. So the, the stereotypes are true. People go into psych for their own reasons. For their own benefit for their own mental health.<br /></p>
                </div>
              </div>
            </div>
            <div className="info_component">
            ...
            <div className="info_component">
              ...
              <div className="info-wrapper rachel">
                <div className="padding-left padding-medium">
                  ...
                  <p className="info-p right-in">But, I also wanted to get a better sense of ASL in and of itself. We didn&#x27;t really stop to do this, but I wonder if you could talk a little bit more about ASL as a language, like more so, what it is like.<br /></p>
                  <p className="info-p right-in">You were talking about how it&#x27;s blunt, if that&#x27;s an appropriate word to use or maybe that&#x27;s just like the, the, how your parents were using it. But can you talk a little bit more about how you learned it and what it is like as a language, or I guess how people who are deaf or just not deaf, like how they use the language, if this question&#x27;s making sense.<br /></p>
                </div>
              </div>
            </div>
            <div className="info_component">
            ...
            <div className="info_component"></div>
            <div className="info_component">
              <div className="info-title-wrapper">
                <h4 className="flip-left-in heading-4">          Guru</h4>
              </div>
              <div className="info-wrapper rachel">
                <div className="padding-left padding-medium">
                  <p className="info-p right-in">The facial expression, I think is really interesting. And in that className, that 1-1 className I&#x27;m curious, like, did they, I guess, how did they teach that?<br /></p>
            ...
            <div className="info_component">
              ...
              <div className="info-wrapper rachel">
                <div className="padding-left padding-medium">
                  <p className="info-p right-in">I feel like even for people who have a surface level awareness of [00:19:00] ASL, they probably won&#x27;t consider the facial expression portion. And like, I&#x27;ll be the first to admit, I&#x27;m only more familiar with it cuz you&#x27;ve explained it to me cuz we&#x27;re friends.<br /></p>
                  <p className="info-p right-in">Have you kind of ever thought about that or talked to your parents or other deaf friends about almost the like, I don&#x27;t know what the right word is like the, like how ASL can in and up itself be generalized or they kind of reduce it to just like hand gestures, as opposed to thinking about all the complexities.<br /></p>
                </div>
              </div>
            </div>
            <div className="info_component">
              ...
              <div className="info-wrapper rachel">
                <div className="padding-left padding-medium">
                  <p className="info-p right-in">Part of the positive experience of taking that ASL className was that the fact that they acknowledged that it&#x27;s a language and it has a culture, there&#x27;s a history, there&#x27;s a culture, there&#x27;s different dialects, there&#x27;s different ways to say different words, just like any other language.<br /></p>
                  <p className="info-p right-in">If you&#x27;re thinking of ASL as oh, you know, some fun tricks here and there. Oh, Hey, I can, a lot of, a lot of times when people are like, oh yeah, I learned ASL for a bit. The [00:20:00] most common thing that I get is like that. I only know how to spell my name. Maybe like please. And thank you. Hi goodbye. And it&#x27;s like that kind of perspective that I get from other people is it&#x27;s usually pretty telling to me is that usually when they learn ASL, they just think it&#x27;s some really cool.<br /></p>
                  <p className="info-p right-in">That&#x27;s why, whenever I go to the store and the cashier is like, oh yeah, I know little sign. I do feel appreciative because it, it tells me that, you know, you could use that when you&#x27;re, you&#x27;re on the job and, you know, some deaf person comes in and they ask you a question and you&#x27;ll be able to help them. And that makes me happier.<br /></p>
                  <p className="info-p right-in">That doesn&#x27;t mean you should sign to every deaf person that you see. They may not need the actual assistance. Obviously you should learn how to ask if they need the help. If they say no, then be respectful about it.<br /></p>
                  <p className="info-p right-in">I think for ASL, especially, it&#x27;s one thing to be like, I&#x27;m learning the language, but if you&#x27;re not actually immersing yourself and talking to deaf people and being in the community and learning more about their experiences, then I don&#x27;t think you&#x27;re [00:21:00] really utilizing the language at all.<br /></p>
                  <p className="info-p right-in">I&#x27;ve looked into some disabled activists and creators and stuff who have said that it&#x27;s one thing to advocate for disabled people, but to not know anyone who&#x27;s disabled, to not be friends with people who are disabled, to not really associate yourselves with people who are disabled, it just feels lackluster.<br /></p>
                  <p className="info-p right-in">It feels performative almost. So that&#x27;s how I feel similarly to people who are learning ASL. On one hand, the purpose is to really utilize it, to understand and better clear up any, stereotypes or misconceptions, I guess about deaf people and maybe advocate for a more accessible world, you know, as allies.<br /></p>
                </div>
              </div>
            </div>
            <div className="info_component">
            ...
            <div className="info_component">
              ...
              <div className="info-wrapper rachel">
                <div className="padding-left padding-medium">
                  <p className="info-p right-in">Maybe it&#x27;s just me being biased, but I have a very distinct memory in my childhood where I spoke to maybe it was like a lawyer or something. It was like some grown up. And I was speaking about the fact that I knew ASL and he literally looked at me like what?<br /></p>
                  <div className="info-p right-in">That&#x27;s a language that counts what, I don&#x27;t think that counts does that count. And it literally stunned me. I was like yeah, it&#x27;s a language. And after I remember actively looking on London and be like, is it really a language, you know, fully immersed in the language and culture.</div>
                  <div className="info-p right-in">I think my mom also started texting me in Korean as well. I still respond in English because the spelling part is hard, but now I can read pretty well.</div>
                  <div className="info-p right-in">But because of that one person, that one person outside of the community being like, is this even? So to answer the question that I was asked in the past for so many years, like, yes, but for the longest time, I was stumped by this sudden fake debate. That&#x27;s like, but I think now whenever I tell this to people like you, when I&#x27;m like, oh [00:23:00] yeah, people used to think that it wasn&#x27;t a language. I&#x27;m glad to hear the, that the, for the most part, the response is like, what? That&#x27;s so dumb. Of course it&#x27;s a language.</div>
                  <p className="info-p right-in">Is it officially recognized as a language in other countries? Every country has their own sign language. That&#x27;s another misconception too, that I got often is like, oh yeah, it&#x27;s ASL universal. Maybe read the acronym,<br /></p>
                </div>
              </div>
            </div>
            <div className="info_component">
            ...
            <div className="info_component">
              ...
              <div className="info-wrapper rachel">
                <div className="padding-left padding-medium">
                  <p className="info-p right-in">Looking back at it, if you ever look into the history of ASL, it&#x27;s predominantly white. So being able to look at it in a new lens, in a more intersectional lens is something that I definitely feel more inclined to look into BS a L is very interesting because I can&#x27;t even say if the way I sign has put fundamentally like BS a L ASL or like just regular ASL, because black people are the blueprint essentially for a lot of things in America. But it only was open until recently where I was like, oh yeah, that makes so much sense that, you [00:25:00] know, black ASL exists because we had segregation, there were segregated schools in America.<br /></p>
                  <p className="info-p right-in">So of course, the way that they learned ASL was different than the deaf children in like white schools. So it has a historical context to it and it just reminds people that it&#x27;s not just this universal, one way easy language.<br /></p>
                </div>
              </div>
            </div>
            <div className="info_component">
            ...
            <div className="info_component">
              ...
              <div className="info-wrapper rachel">
                <div className="padding-left padding-medium">
                  <p className="info-p right-in">Of course. Yeah.<br /></p>
                </div>
              </div>
            </div>
            <div className="info_component">
              ...
              <div className="info-wrapper rachel">
                <div className="padding-left padding-medium">
                  <p className="info-p right-in">Could you imagine spelling your full name?<br /></p>
                </div>
              </div>
            </div>
            <div className="info_component">
            ...
            <div className="info_component">
              ...
              <div className="info-wrapper rachel">
                <div className="padding-left padding-medium">
                  <p className="info-p right-in">No. that takes up too much time. And ASL is all about brevity. Anyways. I do have a sign name. The way sign names work usually is that you just take the letter of your first name and somehow attribute it to a personality trait that you may have. So you just, you know, sign the letter. So for me, it&#x27;s C and then I&#x27;m just gonna use a common sign name. So for girls, just for the audio view listeners, I guess.<br /></p>
                  <p className="info-p right-in">So for sign names, most commonly used by girls they take the letter and they attribute it to their hair. So they may brush the letter up, down their head, or just attribute their like long hair. And if they have short hair or curly hair, they may like do a little.<br /></p>
                  <p className="info-p right-in">To like show the curl and that might be their sign name. So that&#x27;s a common sign name that may be, you know, attributed. It&#x27;s not usually attributed. Sometimes it may be given to you. I just, I don&#x27;t know. I just found one and I just stuck with it. I don&#x27;t think there&#x27;s any true meaning to it. Just my name and that you just kind of shake it.<br /></p>
                  <p className="info-p right-in">There&#x27;s really no reason. I think at some point I was so upset at the fact that I didn&#x27;t have a story behind it that I used to just make, make it up. I used to just make it up. I used to just like, they&#x27;ll be like, oh Cynthia, why is your name? Like, you know, you just shaking your hand and I&#x27;m like, oh, because I just like shaking things.<br /></p>
                </div>
              </div>
            </div>
            <div className="info_component">
              ...
              <div className="info-wrapper rachel">
                <div className="padding-left padding-medium">
                  <p className="info-p right-in">Yeah. So when you&#x27;re introducing yourself to someone for the first time, though, would you like spell out your name and then show them your signed name? Or how would....<br /></p>
                </div>
              </div>
            </div>
            <div className="info_component">
              ...
              <div className="info-wrapper rachel">
                <div className="padding-left padding-medium">
                  <p className="info-p right-in">That&#x27;s how, that&#x27;s how it is. Yep. Cause they wouldn&#x27;t know otherwise.<br /></p>
                </div>
              </div>
            </div>
            <div className="info_component">
              ...
              <div className="info-wrapper rachel">
                <div className="padding-left padding-medium">
                  <p className="info-p right-in">Well, yeah, that&#x27;s what I meant. That&#x27;s like, cause I mean, if I just met you and then you did the shaking thing, I&#x27;d be...<br /></p>
                </div>
              </div>
            </div>
            <div className="info_component">
              ...
              <div className="info-wrapper rachel">
                <div className="padding-left padding-medium">
                  <p className="info-p right-in">Yeah. You&#x27;d have no idea. Yeah. You usually spell it and then you do the sign immediately after.<br /></p>
                </div>
              </div>
            </div>
            <div className="info_component">
              ...
              <div className="info-wrapper rachel">
                <div className="padding-left padding-medium">
                  <p className="info-p right-in">Thank you so much for coming onto the podcast. This has been very illuminating. Very enlightening for a lot of the people who are going to experience this episode. Well, anyways though thank you for sharing all your experiences has been really awesome. And yeah, that is a wrap.<br /></p>
                </div>
              </div>
            </div>
          </div>
