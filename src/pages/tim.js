...
import "../styles.css"
import tim_sister from '../images/tim/tim_sister.jpg';
import tim_mom_highschool from '../images/tim/tim_mom_highschool.jpg';
import lumpia from '../images/tim/lumpia.jpg';
import longanisa from '../images/tim/longanisa.jpg';
import tim_family from '../images/tim/tim_family.jpg';
import young_tim from '../images/tim/young_tim.jpg';
import tim_family_pics from '../images/tim/tim_family_pics.jpg';
import tim_greece from '../images/tim/tim_greece.jpg';
import jose_rizal from '../images/tim/jose_rizal.jpg';
import tim_travel from '../images/tim/tim_travel.jpg';
import tim_sister_mom from '../images/tim/tim_sister_mom.jpg';
import tim_japan from '../images/tim/tim_japan.jpg';
        ...
        <main> 
            ...
            <div className="main-body">
                ...
                <section className="section-wrapper">
                    <div className='text-photo'>
                        <div className='text-arrow'>
                            <p className='handwriting'>Tim's mom in high school</p>
                        </div>
                            <img className="vertical-photo" src={tim_mom_highschool} alt="" loading="lazy" />
                    </div>
                </section>
                ...
                <section className="section-wrapper">
                    <div className='text-photo'>
                        <div className='text-arrow'>
                            <p className='handwriting'>Tim and his sister</p>
                        </div>
                            <img className="vertical-photo" src={tim_sister} alt="" loading="lazy" />
                    </div>
                </section>
                ...
                <section className="section-wrapper">
                    ...
                    <div className="p-wrapper side">
                        <p>How did that then bleed into other parts of your culture, though? Even though they weren't teaching you the language, were you guys still surrounded by a lot of Filipino customs, food, or I guess how deep was that assimilation going?</p>
                    </div>
                </section>
                ...
                <section className="section-wrapper">
                 ...
                 <section className="section-wrapper">
                          <div className='text-photo'>
                        <div className='text-arrow'>
                            <p className='handwriting'>Lumpia and longanisa</p>
                        </div>
                            <img className="vertical-photo" src={lumpia} alt="" loading="lazy" />
                            <img className="vertical-photo" src={longanisa} alt="" loading="lazy" />
                    </div>
                </section>
                ...
                <section className="section-wrapper">
                    ...
                    <div className="p-wrapper side">
                        <p>And could you expand a little bit on what the Filipino community looked like when you were growing up in LA?</p>
                    </div>
                </section>
                ...
                <section className="section-wrapper">
                    ...
                    <div className='p-wrapper side'>
                        <p>I grew up really in Orange County, in Irvine. And the community that I was exposed to was mostly family friends, cousins. But. I don't know, I don't know how to describe it. It was like, it wasn't, it seemed American to me.</p>
                    </div>
                </section>
                <section className="section-wrapper">
                    <div className='text-photo'>
                        <div className='text-arrow'>
                            <p className='handwriting'>Tim's family</p>
                        </div>
                            <img className="horizontal-photo" src={tim_family} alt="" loading="lazy" />
                    </div>
                </section>
                ...
                <section className="section-wrapper">
                    ...
                    <div className='p-wrapper side'>
                        <p>That's a great question. I don't know, just being here. I can't really speak about the Filipino community without speaking about just the community-community that I lived in at large.</p>
                    </div>
                </section>
                ...
                <div className='text-photo'>
                    <div className='text-arrow'>
                        <p className='handwriting'>Young Tim</p>
                    </div>
                        <img className="vertical-photo" src={young_tim} alt="" loading="lazy" />
                </div>
                </section>
                ...
                <section className="section-wrapper">
                    ...
                    <div className="p-wrapper side">
                        <p>Yeah. Was there any kind of external schooling for the Filipino community? I went to this Sunday Indian school, I know people who went to Chinese school or Korean school. Was there ever anything like that for you?</p>
                    </div>
                </section>
                ...
                <section className="section-wrapper">
                    ...
                    <div className='p-wrapper side'>
                        <p>Not that I'm aware of. And, you know, when I got your questions, I was like, oh, did that even exist back then? If it existed, I wasn't exposed to it. And I didn't really know anybody who did it. A lot of the first-generation Filipino Americans that I grew up with are very similar to me in that they can understand the language, but they can't speak it. And, so I didn't know that they ever went to any sort of formal Tagalog classes. I don't know if those existed.</p>
                        <p>Even my grandma, who probably knew English the least, was a very proficient English-speaking person. Heavy accent for sure, but she definitely spoke good English. So, me not being able to speak didn't really affect my relationship with family.</p>
                    </div>
                </section>
                 <section className="section-wrapper">
                    <div className='text-photo'>
                        <div className='text-arrow'>
                            <p className='handwriting'>Tim's family photos</p>
                        </div>
                            <img className="vertical-photo" src={tim_family_pics} alt="" loading="lazy" />
                    </div>
                </section>
                ...
                <section className="section-wrapper">
                    <div className='p-wrapper full'>
                        <b className='extra-bolded'>
                            I used to joke and say English is a first language for every Filipino that lives in post-World War II, like that era of the world. I think you'd be hard pressed to find any Filipino born in America, or born in the Philippines, that can't speak English. I think it's really interesting how peoples' cultures are formed based on how they speak to each other.
                        </b>
                    </div>
                </section>
                ...
                <section className="section-wrapper">
                 ...
                 <section className="section-wrapper">
                    <div className='text-photo'>
                        <div className='text-arrow'>
                            <p className='handwriting'>Tim and his wife Julie in Greece</p>
                        </div>
                            <img className="vertical-photo" src={tim_greece} alt="" loading="lazy" />
                    </div>
                </section>
                <section className="section-wrapper">
                    <div className='p-wrapper full'>
                ...
                <section className="section-wrapper">
                    <div className='text-photo'>
                        <div className='text-arrow'>
                            <p className='handwriting'>José Rizal</p>
                        </div>
                            <img className="vertical-photo" src={jose_rizal} alt="" loading="lazy" />
                    </div>
                </section>
                ...
                <section className="section-wrapper">
                    ...
                    <div className='p-wrapper side'>
                        ...
                        <p>And, it's similar to mine, except I knew I was mispronouncing it my whole life. I was pronouncing my last name, "Boo-muh-tae." And it's "Boo-mah-tai." </p>
                    </div>
                </section>
                ...
                <section className="section-wrapper">
                    ...
                    <div className="p-wrapper side">
                        <p>Well, what is stopping you, I guess?</p>
                    </div>
                </section>
                ...
                <section className="section-wrapper">
                 ...
                 <section className="section-wrapper">
                    <div className='text-photo'>
                        <div className='text-arrow'>
                            <p className='handwriting'>Tim in Singapore</p>
                        </div>
                            <img className="vertical-photo" src={tim_travel} alt="" loading="lazy" />
                    </div>
                </section>
                <section className="section-wrapper">
                    <div className='p-wrapper full'>
                ...
                <section className="section-wrapper">
                   ...
                   <section className="section-wrapper">
                    <div className='text-photo'>
                        <div className='text-arrow'>
                            <p className='handwriting'>Tim with his mom and sister</p>
                        </div>
                            <img className="horizontal-photo" src={tim_sister_mom} alt="" loading="lazy" />
                    </div>
                </section>
                ...
                <section className="section-wrapper">
                    ...
                    <div className="p-wrapper side">
                        <p>Have you thought about planning a trip? I'm sure you've thought about it, but is that on the cards for the next year or two of going to the Philippines?</p>
                    </div>
                </section>
                ...
                <section className="section-wrapper">
                    ...
                    <div className='p-wrapper side'>
                        <p>Yes. A thousand percent. I've been trying to plan this with the family for two or three years now at this point. At this point, it's going to be difficult to just coordinate with multiple people. I think I'm just either going to have to go by myself or with Julie. But, you know, I think Julie and I are considering Japan as our honeymoon [NOTE: Tim and Julie have since gotten married. They did, in fact, go to Japan for their honeymoon.] Even thinking about going to Japan, and not going to the Philippines... It's like, I think I carry around a little bit of guilt just like thinking about it. You're going to be in that part of the world again. 'Cause I just went, I just recently in the last, I think, yeah, a year, year and a half, I went to Singapore and I'm like, I'm in this part of the world. Why am I not going to the Philippines? Yeah, I think it's just been a little difficult to coordinate with family, so I think I'm going to have to just do it.</p>
                  ...
                  <section className="section-wrapper">
                    <div className='text-photo'>
                        <div className='text-arrow'>
                            <p className='handwriting'>Tim and Julie in Japan</p>
                        </div>
                            <img className="vertical-photo" src={tim_japan} alt="" loading="lazy" />
                    </div>
                </section>
                ...
                <section className="section-wrapper">
                    ...
                    <div className='p-wrapper side'>
                        <p>We have a family farm out there that has been just in the family for a long time. It was my grandpa's and my grandma's, and then in the family before that, I think. It has a lot of like really interesting history, especially during the war, where, during Japanese occupation, my grandfather who worked for the government would go to go to work.</p>
                        <p>And, Japanese soldiers knew that he was going to work. After he left, they would come onto the farm and my grandmother would have to take care of them. And then at the end of the day, they would leave.</p>
                    </div>  
                </section>
                <section className="section-wrapper">
                    <div className='p-wrapper full'>
                        <b className='extra-bolded'>
                            My grandfather would come back, and he would grab a gun and try and find these soldiers and try and kill them. And so, this happened on that farm and I'd love to visit that. The farm is not operational anymore. In fact, like our family is not even on there. Poverty is a huge issue in the Philippines. And, I think there's over a hundred people just like kind of squatting on the land now.
                        </b> 
                    </div>
                </section>
                <section className="section-wrapper">
                    <div className='p-wrapper full'>
                        <p>So, just visiting and just seeing that part of my family history would be nice. I think that's the, that's like, if I were to pick one thing that I'm looking forward to, it's seeing that.</p>
                    </div>
                </section>
                ...
                <section className="section-wrapper">
                    ...
                    <div className='p-wrapper side'>
                        <p>Yeah. I think it's lakas. It means strength. That's my word in Tagalog.</p> 
                    </div>
                </section>
                <section className='section-wrapper'>
                    <div className='p-wrapper full'>
                ...
                <section className="section-wrapper">
                    <div className='text-photo'>
                        <div className='text-arrow'>
                            <p className='handwriting'>Tim and Julie at their wedding</p>
                        </div>
                            <img className="vertical-photo" src={tim_wedding} alt="" loading="lazy" />
                    </div>
                </section>
...
export const Head = () => <title>Tim Bumatay Interview</title>
