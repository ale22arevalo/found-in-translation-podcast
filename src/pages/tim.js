            ...
            <div className="main-body">
                ...
                <section className="section-wrapper">
                    ...
                    <div className='p-wrapper side'>
                        ...
                        <p>And it's similar to mine, except I knew I was mispronouncing it my whole life. I was pronouncing my last name, Bumatay</p>
                    </div>
                </section>
                ...
                <section className="section-wrapper">
                    ...
                    <div className='p-wrapper side'>
                        ...
                        <p>And it's like Timmy Bumatay and I'd be like, yes, that is correct. It wasn't until I was like, Oh, well, maybe I should stop going by Timmy and just go by Tim now as like a sign of like, I'm an adult or whatever. But what's your last name, dude?</p>
                    </div>
                </section>
                <section className='section-wrapper'>
                    <div className='p-wrapper full'>
                ...
                <section className="section-wrapper">
                    <div className='p-wrapper full'>
                        <b className='extra-bolded'>
                            My grandfather would come back and he would grab a gun and try and find these soldiers and try and kill them. And so this happened on that farm and I'd love to visit that. The farm is not operational anymore. In fact, like our family is not even on there. We have this poverty is a huge issue in the Philippines. And I think there's Over a hundred people just like kind of squatting on the land now.
                        </b> 
                    </div>
                </section>
                <section className="section-wrapper">
