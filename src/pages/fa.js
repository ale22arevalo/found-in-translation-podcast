      ...
      <div className="main-body">
            <section className='section-wrapper'>
              ...
              <div className='p-wrapper side'>
                <div class="padding-left padding-medium">
                  ...
                  <p class="info-p right-in prevphoto">
                    <a href="https://www.rachelhaeunlee.com/" target="_blank" class="hoverable-link">‍</a>This week&#x27;s guest is ajhbcjajnjkcnajncja.<br />
                  </p><img class="image-414 phot-fader" src="images/headshot.jpg" alt="" sizes="100vw" data-w-id="7a7ef6b4-6cf6-1d1e-0c59-b590f503e0a7" loading="lazy" srcset="images/headshot-p-500.jpg 500w, images/headshot-p-800.jpg 800w, images/headshot-p-1080.jpg 1080w, images/headshot.jpg 1512w" />
                  <p> bcsahjjcajk<br /></p>
                  <p><b>A </b>s‍<br /><b>B </b>bcxhkabjkca<br /><b>C </b> kjnckajncja<br /><b>D)</b> acjbajnkva<br /></p>
            ...
            <div className='section-wrapper'>
              <div className='p-wrapper side'>
                ...
                <h2 data-w-id="5bc7f160-43c1-530a-c3f4-65b9f4219b9c" class="span-subheading popping fadder tabs mbile">Going back to your early childhood, growing up in Dhaka, what was your connection to Bengali or how did it play out when you were growing up?</h2>
              </div>
            </div>
            <section className='section-wrapper'>
              <div class="info-title-wrapper">
                <h4 class="flip-left-in heading-4 titulo">The Guest</h4>
                <h3 
                ...
                class="flip-left-in"><span class="the-span">Fareeha </span>mAHMOOD</h3>
              </div>
              <div className='p-wrapper side'>
                <div class="padding-left padding-medium">
            ...
            <div className='section-wrapper'>
              <div class="info-title-wrapper">
                <h4 class="flip-left-in heading-4 guru">              Guru</h4>
              </div>
              <div class="info-wrapper rachel">
                <div class="padding-left padding-medium">
            ...
            <div className='section-wrapper'>
              <div class="info-title-wrapper">
                <h4 class="flip-left-in heading-4">        Fareeha</h4>
              </div>
              <div class="info-wrapper rachel">
                <div class="padding-left padding-medium">
            ...
            <div className='section-wrapper'>
              <div className='p-wrapper side'>
                <h2 data-w-id="869e026c-7fae-d570-381b-544bf71c2700" class="heading-8 fader">I lost that after like second grade when I moved to Jakarta.</h2>
            ...
            <div className='section-wrapper'>
              <div class="info-title-wrapper">
                <h4 class="flip-left-in heading-4">           Guru</h4>
              </div>
              <div class="info-wrapper rachel">
                <div class="padding-left padding-medium">
            ...
            <div className='section-wrapper'>
              <div className='p-wrapper side'>
                <h2 data-w-id="35a57260-3313-32da-a27f-071029f4a8ce" class="heading-8 fader nametag">Fareeha</h2>
                <p>It would be a lot of essays.<b><br /></b></p>
                <h2 data-w-id="139a822a-a1cc-953b-640b-ba8346535f9b" class="heading-8 fader nametag">Guru</h2>
                <p>Yeah.  But that was my whole other tangent. I just thought it was very interesting though.</p>
                <h2 data-w-id="3cb94a05-5cdc-0a10-7601-f09c52554c33" class="heading-8 fader nametag">Fareeha</h2>
                ...
                <h2 data-w-id="13ebd7fd-0df7-7839-593a-38204c4d30f3" class="heading-8 fader nametag">Guru</h2>
            ...
            <div className='section-wrapper'>
              <div className='p-wrapper side'>
                <p>Guru</p>
                <h2 data-w-id="75d5c71e-e504-c440-8d14-df90d053bd97" class="span-subheading popping fadder question">Going back to, when you were saying you wanted to invest yourself more now with learning Bengali or Bangla. <br /><br />how much have you immersed yourself with Bengali media and if so, has that helped with your understanding, reading, writing, comprehension...</h2>
              </div>
            </div>
            <div className='section-wrapper'>
              <div class="info-title-wrapper">
                <h4 class="flip-left-in heading-4 guru">     Fareeha</h4>
              </div>
              <div class="info-wrapper rachel">
                <div class="padding-left padding-medium">
            ...
            <div className='section-wrapper'>
              <div className='p-wrapper side'>
                <p>Guru</p>
                <h2 data-w-id="58e69624-95ae-647c-b0b9-82e4a7d1d901" class="span-subheading popping fadder question">When you came to NYU, did you go to any kind of Bengali student association?</h2>
              </div>
            </div>
            <div className='section-wrapper'>
              <div class="info-title-wrapper">
            ...
            <div className='section-wrapper'>
              <div className='p-wrapper side'>
                <h2 data-w-id="d70a9894-81f6-0d8c-5b84-1429135332c2" class="heading-8 fader nametag">Guru</h2>
                ...
                <h2 data-w-id="d70a9894-81f6-0d8c-5b84-1429135332d1" class="heading-8 fader nametag">Fareeha</h2>
            ...
            <div className='section-wrapper'>
              <div className='p-wrapper side'>
                <p>Guru</p>
                <h2 data-w-id="a590fab7-0356-cbdf-2d5c-69cb275450c7" class="span-subheading popping fadder question">All right.  Cool. Well as we&#x27;re wrapping up, if you just wanna plug your socials or anything else you&#x27;re like working on.</h2>
              </div>
            </div>
            <div className='section-wrapper'>
              <div className='p-wrapper side'>
                <h2 data-w-id="5b1a1937-bb62-a32e-1331-c5fa1bf12821" class="heading-8 fader nametag">Fareeha</h2>
                ...
                <h2 data-w-id="5b1a1937-bb62-a32e-1331-c5fa1bf12825" class="heading-8 fader nametag">Guru</h2>
                <p>Is it on Amazon or where can people find it?</p>
                <h2 data-w-id="5b1a1937-bb62-a32e-1331-c5fa1bf12829" class="heading-8 fader nametag">Fareeha</h2>
                <p>Yeah, it&#x27;s on the Barnes &amp;Noble website, Amazon. I think it should be on all the major sites,<b><br /></b></p>
                <h2 data-w-id="5b1a1937-bb62-a32e-1331-c5fa1bf1282f" class="heading-8 fader nametag">Guru</h2>
                ...
                <h2 data-w-id="d26db0db-9e84-aa2c-73c3-f02c2973548b" class="heading-8 fader nametag">Fareeha</h2>
                <p>I feel so special. What an honor.</p>
                <h2 data-w-id="dbc3d15f-d88e-29f6-cfb7-bc64eb9f6c4c" class="heading-8 fader nametag">Guru</h2>
            ...
            <div className='section-wrapper'>
              <div className='p-wrapper side'>
                <p>Guru</p>
                <h2 data-w-id="96ee040b-b379-b87d-1827-8d9d2bc025a8" class="span-subheading popping fadder question">Thank you so much again for listening. and as always, please like, share, comment, eTC, and whatever else will help us go viral.</h2>
              </div>
        </div>
      </div>
    </main>
